"""
Takes in the transcript from a YouTube video ->
Sends a query with a designed prompt to the Perplexity API ->
...
if __name__ == "__main__":
    example_transcript = "Your transcript here."
    example_title = "Title of the Event"
    
    api_response = query(example_transcript, example_title)
    print(api_response)